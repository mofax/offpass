...
import { saveVault, getVault, getAllVaults, deleteVault } from './storage';
import type { EncryptedVault, Vault, VaultData, Credential } from './types';
...
export async function openVault(
	id: string,
	masterPassword: string
): Promise<{ vault: Vault; data: VaultData }> {
