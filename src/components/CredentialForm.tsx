...
export default function CredentialForm({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      category: editingCredential?.category || vaultData?.settings?.defaultCategory || "Login",
  ...
  const categories = vaultData?.settings?.categories || ["Login", "Financial", "Personal", "Work"];
                  ...
                  {field.value && (
                    <div className="mt-1">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs">Strength: {getPasswordStrengthLabel()}</span>
                      </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="E.g., work, important (comma separated)" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
