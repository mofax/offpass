...
import { PlusCircle, Lock, Settings } from 'lucide-react';
...
export default function Sidebar({
	...
	const { vaultData, currentVault, lockVault } = usePasswordManager();
	...
	return (
		<div className="w-64 h-full bg-card/50 backdrop-blur-sm border-r border-border p-4 flex flex-col">
			...
			<Button onClick={onAddCredential} className="mb-6">
